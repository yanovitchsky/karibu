...
class Service < Karibu::Client
  ...
  connection_string "tcp://jarvis.service.consul:32798"
  timeout 60
  endpoint "Jarvis"
...
#   # endpoint "Message"
# end
# p Service::Jarvis.find :pack_id, :adwords_customer_id, "50850beb8a5da54521000038" #=> {:pack_id => "" | [], calltracking_id: "50850beb8a5da54521000038"}
# t = Time.now
